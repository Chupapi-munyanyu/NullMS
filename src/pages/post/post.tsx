        ...
        <header className="Post-header">
          ...
          <Box>
            <div className="relative">
              ...
              <label htmlFor="nickname" className="absolute text-gray-500 dark:text-gray-400 duration-300 transhtmlForm -translate-y-8 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-[#121212] px-2 peer-focus:px-2 peer-focus:text-cyan-600 peer-focus:dark:text-cyan-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-8 left-1">Nickname</label>
            </div>
            <div className="flex">
          ...
          <Box>
            ...
            <br />
            <button className="glyph_button" onClick={() => setText(glyphs + '1')}>1</button>
            <button className="glyph_button" onClick={() => setText(glyphs + '2')}>2</button>
            <button className="glyph_button" onClick={() => setText(glyphs + '3')}>3</button>
            <button className="glyph_button" onClick={() => setText(glyphs + '4')}>4</button>
            <button className="glyph_button" onClick={() => setText(glyphs + '5')}>5</button>
            <button className="glyph_button" onClick={() => setText(glyphs + '6')}>6</button>
            <button className="glyph_button" onClick={() => setText(glyphs + '7')}>7</button>
            <button className="glyph_button" onClick={() => setText(glyphs + '8')}>8</button>
            <br />
            <button className="glyph_button" onClick={() => setText(glyphs + '9')}>9</button>
            <button className="glyph_button" onClick={() => setText(glyphs + '0')}>0</button>
            <button className="glyph_button" onClick={() => setText(glyphs + 'A')}>A</button>
            <button className="glyph_button" onClick={() => setText(glyphs + 'B')}>B</button>
            <button className="glyph_button" onClick={() => setText(glyphs + 'C')}>C</button>
            <button className="glyph_button" onClick={() => setText(glyphs + 'D')}>D</button>
            <button className="glyph_button" onClick={() => setText(glyphs + 'E')}>E</button>
            <button className="glyph_button" onClick={() => setText(glyphs + 'F')}>F</button>
          </Box>
